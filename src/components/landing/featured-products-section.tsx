...
export const FeaturedProductsSection = () => {
  const products = [
    { category: 'FLOWER POTS', title: 'Flower Pots Big', price: 450 },
    { category: 'AERIAL SHOTS', title: 'Sky Shot', price: 850 },
    { category: 'ROCKETS', title: 'Rocket Classic', price: 380 },
    { category: 'GROUND CHAKKARS', title: 'Ground Chakkar', price: 280 },
  ];
    ...
    <section id="products" className="py-24 bg-white border-t border-gray-100 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {products.map((prod, idx) => (
          <div key={idx} className="bg-white border border-gray-200 rounded-xl p-4 flex flex-col justify-between shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="pt-4">
              <button className="w-full bg-[#d97706] hover:bg-yellow-600 text-white font-poppins font-semibold text-xs py-3 rounded-md transition-colors shadow-sm">
                Add to List
              </button>
            </div>
          </div>
