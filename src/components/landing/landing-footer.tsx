...
import { MapPin, Phone, Mail } from 'lucide-react'; // Removed the social icons from here

// Inline SVGs for the missing social brand icons
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="font-noto text-sm text-gray-400 leading-relaxed">
              Premium Quality Fireworks from the heart of Sivakasi. Direct factory outlet illuminating your celebrations with joy and safety.
            </p>
